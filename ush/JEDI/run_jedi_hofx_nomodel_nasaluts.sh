...
if ( echo ${AODTYPE} | grep -q "AERONET" ); then
    ...
    ${NLN} /scratch1/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/expCodes/fv3-bundle/V20230312/build//geos-aero/test/testinput/geosaod_aeronet.rc ${DATA}/geosaod_aeronet.rc
fi
